...
export const SET_SIDEBAR_ACTIVE_HOME = "SIDEBAR_ACTIVE_HOME"
...
const sidebarReducer = (state = initialState, action) => {
    switch(action.type) {
        case SET_SIDEBAR_ACTIVE_HOME:
            console.log(SET_SIDEBAR_ACTIVE_HOME)
            return {
                ...state,
                sidebarActive: SET_SIDEBAR_ACTIVE_HOME
            }
